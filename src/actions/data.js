...
export const promotions = [
                    {'course': 'Lego', 'level': 'beginner','id': 0, 'learnMore': 'Learn More' ,'img': '/assets/img/home/lego_cropped.png', 'duration': 'Duration: 6 months', 'description': 'Entry level robotics course with adorable LEGO Mindstorm robotics education platform'},
                    {'course': 'Arduino', 'level': 'intermediate' ,'id': 1, 'learnMore': 'Learn More' ,'img': '/assets/img/home/arduino_cropped.png', 'duration': 'Duration: 6 months', 'description': 'Intermediate level robotics course with the most popular open-source hardware platform, Arduino.'},
                    {'course': 'Raspberry Pi', 'level': 'advanced' ,'id': 2, 'learnMore': 'Learn More' ,'img': '/assets/img/home/RPi_cropped.png', 'duration': 'Duration: 6 months', 'description': 'Advanced level robotics course with powerful linux computer Raspberry Pi.'}
                   ];
...
export const courses = [

	                  {
	                  	...
	                  	courses: [
	                               {'course': 'Lego 1: Basic movement and sensors', 'level': 'Degree level: Lego', 'id': 0, 'img': '/assets/img/lego/level1.jpg', 'price': 'Price $300', 'description': 'This section includes an introduction to the Lego Mindstorm. The students will learn about basic modules and sensors. It is for students with no background on Lego Mindstorm.', 'duration': 'Duration: 1.5 Months', courseDate: 'Course Schedule: SAT 14:00pm', startDate: 'Start from: Oct.1'},
	                               {'course': 'Lego 2: More sensors and logic decisions', 'level': 'Degree level: Lego', 'id': 0, 'img': '/assets/img/lego/level2.png', 'price': 'Price $350', 'description': 'This section is for students who understand basic movement and sensor use. The students will learn about more sensor and simple logic programming in this section.', 'duration': 'Duration: 1.5 Months', courseDate: 'Course Schedule: SAT 16:00pm', startDate: 'Start from: Oct.1'},
	                               {'course': 'Lego 3: Control theory', 'level': 'Degree level: Lego', 'id': 0, 'img': '/assets/img/lego/level3.jpg', 'price': 'Price $400', 'description': 'This section is for students already understanding basic movement and control. The students will learn about simple control theory in this section.', 'duration': 'Duration: 1.5 Months',  courseDate: 'Course Schedule: SUN 14:00pm', startDate: 'Start from: Oct.1'},
	                               {'course': 'Lego 4: Grand project', 'level': 'Degree level: Lego', 'id': 0, 'img': '/assets/img/lego/level4.png', 'price': 'Price $450', 'description': 'In this section, the students will build their own grand project with the help from the teachers.', 'duration': 'Duration: 1.5 Months', courseDate: 'Course Schedule: SUN 16:00pm', startDate: 'Start from: Oct.1'},
	                  ]},

	                  {
	                  	...
	                  	courses: [
	                               {'course': 'Arduino 1: Introduction and basic sensors', 'level': 'Degree level: Arduino', 'id': 0, 'img': '/assets/img/arduino/level1.jpg', 'price': 'Price: 350', 'description': 'In this section, the Arduino hardware platform and software IDE are introduced. Students will also learn about usage of basic sensors.', 'duration': 'Duration: 2 Months', courseDate: 'Course schedule: SAT 10:00am', startDate: 'Start Date Oct.1'},
	                               {'course': 'Arduino 2: Robot arm and control', 'level': 'Degree level: Arduino', 'id': 0, 'img': '/assets/img/arduino/level2.jpg', 'price': 'Price: 400', 'description': 'This section is for students who understand Arduino and programming with IDE. Students will learn about servo motor and robot arm design in this section.', 'duration': 'Duration: 2 Months', courseDate: 'Course schedule: SAT 12:00pm', startDate: 'Oct.1'},
	                               {'course': 'Arduino 3: Mobile platform', 'level': 'Degree level: Arduino', 'id': 0, 'img': '/assets/img/arduino/level3.jpg', 'price': 'Price: 450', 'description': 'This section is for students who has a good understanding of motor control and sensors usage with Arduino. In this section, students will learn how to build a mobile platform and program for it', 'duration': 'Duration: 2 Months', courseDate: 'Course schedule: SUN 10:00pm', startDate: 'Oct.1'},
	                               {'course': 'Arduino 4: Grand project', 'level': 'Degree level: Arduino', 'id': 0, 'img': '/assets/img/arduino/level4.jpg', 'price': 'Price: 500', 'description': 'In this section, the students will build their own grand project with the help from the teachers', 'duration': 'Duration: 2 Months', courseDate: 'Course schedule: SAT 12:00pm', startDate: 'Oct.1'},
	                  ]},
